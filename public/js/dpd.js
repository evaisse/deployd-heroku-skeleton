 ...
 */
! function(n, e) {
    "function" == typeof define && define.amd ? define(e) : "object" == typeof exports ? module.exports = e() : n.ayepromise = e()
}(this, function() {
    "use strict";
    var n = {},
        e = function() {
        ...
        t = function(n) {
            var e = n && n.then;
            return "object" == typeof n && "function" == typeof e ? function() {
            ...
            var r = n.defer(),
                o = function(n, e) {
                    setTimeout(function() {
                        ...
                        t === r.promise ? r.reject(new TypeError("Cannot resolve promise with itself")) : r.resolve(t)
                    }, 1)
                },
                i = function(n) {
                    e && e.call ? o(e, n) : r.resolve(n)
                },
                c = function(n) {
                    t && t.call ? o(t, n) : r.reject(n)
                };
            return {
                promise: r.promise,
                handle: function(n, e) {
    ...
    return n.defer = function() {
            var n, c = o,
                ...
                p = function(e, t) {
                    var u = r(e, t);
                    return c === o ? f.push(u) : u.handle(c, n),
                        u.promise
                },
                v = function(n) {
                    var t = e();
...
(function() {
    ...
    function sendRequest(url, options) {
        ...
        if (!req)
            return Error("AJAX is somehow not supported");
...
(function(undefined) {
    ...
    function checkAndConnectSocketIO() {
        if (!socket) {
            ...
            var wsurl = url[0].replace('http', 'ws') + '//' + url[2] + "/socket.io";
            ...
            window.dpd.on('reconnect', function() {
                if (_sessionId)
                    window.dpd.setSessionId(_sessionId, true);
            });
        }
    }
